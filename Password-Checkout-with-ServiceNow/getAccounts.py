...
# through REST API
# To get a list of Privilege Accounts associated with a Resource
...
r = requests.post(url, json={"Computer": resourceID}, headers=headers, verify=verify)
r.raise_for_status
responseObject = r.json()
#print responseObject

print 'Privilege Account _RowKey: ' + responseObject['Result'][0]['_RowKey']
print 'Privilege Accout _RowKey: '  + responseObject['Result'][1]['_RowKey']
print 'Privilege Accout _RowKey: '  + responseObject['Result'][2]['_RowKey']
